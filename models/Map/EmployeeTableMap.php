...
class EmployeeTableMap extends TableMap
{
     ...
     */
    const COL_DATE_OF_BIRTH = 'employee.date_of_birth';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'FirstName', 'LastName', 'Salary', 'DepartmentId', 'Address', 'DateOfBirth', ),
        self::TYPE_CAMELNAME     => array('id', 'firstName', 'lastName', 'salary', 'departmentId', 'address', 'dateOfBirth', ),
        self::TYPE_COLNAME       => array(EmployeeTableMap::COL_ID, EmployeeTableMap::COL_FIRST_NAME, EmployeeTableMap::COL_LAST_NAME, EmployeeTableMap::COL_SALARY, EmployeeTableMap::COL_DEPARTMENT_ID, EmployeeTableMap::COL_ADDRESS, EmployeeTableMap::COL_DATE_OF_BIRTH, ),
        self::TYPE_FIELDNAME     => array('ID', 'first_name', 'last_name', 'salary', 'department_id', 'address', 'date_of_birth', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'FirstName' => 1, 'LastName' => 2, 'Salary' => 3, 'DepartmentId' => 4, 'Address' => 5, 'DateOfBirth' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'firstName' => 1, 'lastName' => 2, 'salary' => 3, 'departmentId' => 4, 'address' => 5, 'dateOfBirth' => 6, ),
        self::TYPE_COLNAME       => array(EmployeeTableMap::COL_ID => 0, EmployeeTableMap::COL_FIRST_NAME => 1, EmployeeTableMap::COL_LAST_NAME => 2, EmployeeTableMap::COL_SALARY => 3, EmployeeTableMap::COL_DEPARTMENT_ID => 4, EmployeeTableMap::COL_ADDRESS => 5, EmployeeTableMap::COL_DATE_OF_BIRTH => 6, ),
        self::TYPE_FIELDNAME     => array('ID' => 0, 'first_name' => 1, 'last_name' => 2, 'salary' => 3, 'department_id' => 4, 'address' => 5, 'date_of_birth' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('department_id', 'DepartmentId', 'INTEGER', 'department', 'ID', true, null, null);
  ...
  array (
    ...
    1 => ':ID',
        ...
        $this->addRelation('Employeephone', '\\Employeephone', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':employee_id',
    1 => ':ID',
  ),
), null, null, 'Employeephones', false);
  ...
  array (
    ...
    1 => ':ID',
        ...
        $this->addRelation('Timeslot', '\\Timeslot', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':employee_id',
    1 => ':ID',
  ),
), null, null, 'Timeslots', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(EmployeeTableMap::COL_DATE_OF_BIRTH);
        } else {
