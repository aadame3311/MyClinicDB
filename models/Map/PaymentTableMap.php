...
class PaymentTableMap extends TableMap
{
     ...
     */
    const COL_BILL_ID = 'payment.bill_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'BillId', 'Amount', 'Type', ),
        self::TYPE_CAMELNAME     => array('id', 'billId', 'amount', 'type', ),
        self::TYPE_COLNAME       => array(PaymentTableMap::COL_ID, PaymentTableMap::COL_BILL_ID, PaymentTableMap::COL_AMOUNT, PaymentTableMap::COL_TYPE, ),
        self::TYPE_FIELDNAME     => array('ID', 'bill_id', 'amount', 'type', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'BillId' => 1, 'Amount' => 2, 'Type' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'billId' => 1, 'amount' => 2, 'type' => 3, ),
        self::TYPE_COLNAME       => array(PaymentTableMap::COL_ID => 0, PaymentTableMap::COL_BILL_ID => 1, PaymentTableMap::COL_AMOUNT => 2, PaymentTableMap::COL_TYPE => 3, ),
        self::TYPE_FIELDNAME     => array('ID' => 0, 'bill_id' => 1, 'amount' => 2, 'type' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('bill_id', 'BillId', 'INTEGER', 'bill', 'ID', true, null, null);
    ...
    {
        $this->addRelation('Bill', '\\Bill', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':bill_id',
    1 => ':ID',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PaymentTableMap::COL_BILL_ID);
