...
class DepartmentTableMap extends TableMap
{
     ...
     */
    const COL_DEPARTMENT_NAME = 'department.department_name';

    /**
     * the column name for the section field
     */
    const COL_SECTION = 'department.section';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'DepartmentName', 'Section', ),
        self::TYPE_CAMELNAME     => array('id', 'departmentName', 'section', ),
        self::TYPE_COLNAME       => array(DepartmentTableMap::COL_ID, DepartmentTableMap::COL_DEPARTMENT_NAME, DepartmentTableMap::COL_SECTION, ),
        self::TYPE_FIELDNAME     => array('ID', 'department_name', 'section', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'DepartmentName' => 1, 'Section' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'departmentName' => 1, 'section' => 2, ),
        self::TYPE_COLNAME       => array(DepartmentTableMap::COL_ID => 0, DepartmentTableMap::COL_DEPARTMENT_NAME => 1, DepartmentTableMap::COL_SECTION => 2, ),
        self::TYPE_FIELDNAME     => array('ID' => 0, 'department_name' => 1, 'section' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('department_name', 'DepartmentName', 'VARCHAR', true, 255, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(DepartmentTableMap::COL_SECTION);
        } else {
