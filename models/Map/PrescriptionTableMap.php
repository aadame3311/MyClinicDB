...
class PrescriptionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.PrescriptionTableMap';
     ...
     */
    const OM_CLASS = '\\Prescription';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Prescription';
     ...
     */
    const COL_ID = 'prescription.ID';

    /**
     * the column name for the patient_id field
     */
    const COL_PATIENT_ID = 'prescription.patient_id';

    /**
     * the column name for the prescription_date field
     */
    const COL_PRESCRIPTION_DATE = 'prescription.prescription_date';
  ...
  array (
    ...
    1 => ':ID',
        ...
        $this->addRelation('Medicine', '\\Medicine', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':prescription_id',
    1 => ':ID',
  ),
), null, null, 'Medicines', false);
    } // buildRelations()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PrescriptionTableMap::COL_ID);
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(PrescriptionTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(PrescriptionTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new PrescriptionTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(PrescriptionTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(PrescriptionTableMap::COL_ID) && $criteria->keyContainsValue(PrescriptionTableMap::COL_ID) ) {
...
} // PrescriptionTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
PrescriptionTableMap::buildTableMap();
