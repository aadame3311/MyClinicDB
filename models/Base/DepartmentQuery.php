 ...
 * @method     ChildDepartmentQuery orderBySection($order = Criteria::ASC) Order by the section column
 *
 ...
 * @method     ChildDepartmentQuery groupBySection() Group by the section column
 *
 ...
 * @method     ChildDepartment findOneByDepartmentName(string $department_name) Return the first ChildDepartment filtered by the department_name column
 * @method     ChildDepartment findOneBySection(string $section) Return the first ChildDepartment filtered by the section column *
 ...
 * @method     ChildDepartment requireOneBySection(string $section) Return the first ChildDepartment filtered by the section column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildDepartment[]|ObjectCollection findByDepartmentName(string $department_name) Return ChildDepartment objects filtered by the department_name column
 * @method     ChildDepartment[]|ObjectCollection findBySection(string $section) Return ChildDepartment objects filtered by the section column
...
abstract class DepartmentQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT ID, department_name, section FROM department WHERE ID = :p0';
        try {
    ...
    public function filterByDepartmentName($departmentName = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(DepartmentTableMap::COL_DEPARTMENT_NAME, $departmentName, $comparison);
    }
    ...
    public function filterBySection($section = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(DepartmentTableMap::COL_SECTION, $section, $comparison);
    }
