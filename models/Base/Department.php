...
abstract class Department implements ActiveRecordInterface
{
     ...
     * @return $this|\Department The current object (for fluent API support)
     */
    ...
    public function setSection($v)
    {
        ...
        if ($this->section !== $v) {
            $this->section = $v;
            $this->modifiedColumns[DepartmentTableMap::COL_SECTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DepartmentTableMap::translateFieldName('Section', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DepartmentTableMap::COL_SECTION)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DepartmentTableMap::COL_SECTION)) {
            $criteria->add(DepartmentTableMap::COL_SECTION, $this->section);
        }
