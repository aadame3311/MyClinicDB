 ...
 *
 *
 * @method     ChildPrescriptionQuery orderById($order = Criteria::ASC) Order by the ID column
 ...
 *
 * @method     ChildPrescriptionQuery leftJoinEmployee($relationAlias = null) Adds a LEFT JOIN clause to the query using the Employee relation
 * @method     ChildPrescriptionQuery rightJoinEmployee($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Employee relation
 * @method     ChildPrescriptionQuery innerJoinEmployee($relationAlias = null) Adds a INNER JOIN clause to the query using the Employee relation
 *
 * @method     ChildPrescriptionQuery joinWithEmployee($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Employee relation
 *
 * @method     ChildPrescriptionQuery leftJoinWithEmployee() Adds a LEFT JOIN clause and with to the query using the Employee relation
 * @method     ChildPrescriptionQuery rightJoinWithEmployee() Adds a RIGHT JOIN clause and with to the query using the Employee relation
 * @method     ChildPrescriptionQuery innerJoinWithEmployee() Adds a INNER JOIN clause and with to the query using the Employee relation
 *
 * @method     ChildPrescriptionQuery leftJoinMedicine($relationAlias = null) Adds a LEFT JOIN clause to the query using the Medicine relation
 * @method     ChildPrescriptionQuery rightJoinMedicine($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Medicine relation
 * @method     ChildPrescriptionQuery innerJoinMedicine($relationAlias = null) Adds a INNER JOIN clause to the query using the Medicine relation
 *
 * @method     ChildPrescriptionQuery joinWithMedicine($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Medicine relation
 *
 * @method     ChildPrescriptionQuery leftJoinWithMedicine() Adds a LEFT JOIN clause and with to the query using the Medicine relation
 * @method     ChildPrescriptionQuery rightJoinWithMedicine() Adds a RIGHT JOIN clause and with to the query using the Medicine relation
 * @method     ChildPrescriptionQuery innerJoinWithMedicine() Adds a INNER JOIN clause and with to the query using the Medicine relation
 *
 * @method     \PatientQuery|\EmployeeQuery|\MedicineQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 * @method     ChildPrescription findOne(ConnectionInterface $con = null) Return the first ChildPrescription matching the query
 ...
 *
 * @method     ChildPrescription requireOneById(int $ID) Return the first ChildPrescription filtered by the ID column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
...
abstract class PrescriptionQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = '\\Prescription', $modelAlias = null)
    {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(PrescriptionTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(PrescriptionTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(PrescriptionTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(PrescriptionTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PrescriptionTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByPatientId($patientId = null, $comparison = null)
    {
        if (is_array($patientId)) {
            ...
            if (isset($patientId['min'])) {
                $this->addUsingAlias(PrescriptionTableMap::COL_PATIENT_ID, $patientId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($patientId['max'])) {
                $this->addUsingAlias(PrescriptionTableMap::COL_PATIENT_ID, $patientId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PrescriptionTableMap::COL_PATIENT_ID, $patientId, $comparison);
    }

    /**
     * Filter the query on the prescription_date column
     *
     * Example usage:
     * <code>
    ...
    public function filterByPrescriptionDate($prescriptionDate = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PrescriptionTableMap::COL_PRESCRIPTION_DATE, $prescriptionDate, $comparison);
    }
    ...
    public function filterByEmployeeId($employeeId = null, $comparison = null)
    {
        if (is_array($employeeId)) {
            ...
            if (isset($employeeId['min'])) {
                $this->addUsingAlias(PrescriptionTableMap::COL_EMPLOYEE_ID, $employeeId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($employeeId['max'])) {
                $this->addUsingAlias(PrescriptionTableMap::COL_EMPLOYEE_ID, $employeeId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildPrescriptionQuery The current query, for fluid interface
     */
    public function filterByPatient($patient, $comparison = null)
    {
        if ($patient instanceof \Patient) {
            return $this
                ->addUsingAlias(PrescriptionTableMap::COL_PATIENT_ID, $patient->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PrescriptionTableMap::COL_PATIENT_ID, $patient->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByEmployee($employee, $comparison = null)
    {
        if ($employee instanceof \Employee) {
            return $this
                ->addUsingAlias(PrescriptionTableMap::COL_EMPLOYEE_ID, $employee->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PrescriptionTableMap::COL_EMPLOYEE_ID, $employee->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    /**
     * Filter the query by a related \Medicine object
     *
     * @param \Medicine|ObjectCollection $medicine the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPrescriptionQuery The current query, for fluid interface
     */
    public function filterByMedicine($medicine, $comparison = null)
    {
        if ($medicine instanceof \Medicine) {
            return $this
                ->addUsingAlias(PrescriptionTableMap::COL_ID, $medicine->getPrescriptionId(), $comparison);
        } elseif ($medicine instanceof ObjectCollection) {
            return $this
                ->useMedicineQuery()
                ->filterByPrimaryKeys($medicine->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByMedicine() only accepts arguments of type \Medicine or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the Medicine relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildPrescriptionQuery The current query, for fluid interface
     */
    public function joinMedicine($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('Medicine');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'Medicine');
        }
    ...
    /**
     * Use the Medicine relation Medicine object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \MedicineQuery A secondary query class using the current class as primary query
     */
    public function useMedicineQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinMedicine($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Medicine', '\MedicineQuery');
    }
    ...
    {
        if ($prescription) {
            $this->addUsingAlias(PrescriptionTableMap::COL_ID, $prescription->getId(), Criteria::NOT_EQUAL);
        }
