...
/**
 * Base class that represents a row from the 'patientphone' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Patientphone implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PatientphoneTableMap';
    ...
    /**
     * Initializes internal state of Base\Patientphone object.
     */
    ...
    /**
     * Compares this with another <code>Patientphone</code> instance.  If
     * <code>obj</code> is an instance of <code>Patientphone</code>, delegates to
     * <code>equals(Patientphone)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Patientphone The current object, for fluid interface
     */
    ...
    public function setPhoneNumber($v)
    {
        ...
        if ($this->phone_number !== $v) {
            $this->phone_number = $v;
            $this->modifiedColumns[PatientphoneTableMap::COL_PHONE_NUMBER] = true;
        }
    ...
    public function setPatientId($v)
    {
        ...
        if ($this->patient_id !== $v) {
            $this->patient_id = $v;
            $this->modifiedColumns[PatientphoneTableMap::COL_PATIENT_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 2; // 2 = PatientphoneTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Patientphone'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPatientphoneQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Patientphone::setDeleted()
     * @see Patientphone::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPatientphoneQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PatientphoneTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PatientphoneTableMap::COL_PHONE_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'phone_number';
        }
        if ($this->isColumnModified(PatientphoneTableMap::COL_PATIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'patient_id';
        }

        $sql = sprintf(
            'INSERT INTO patientphone (%s) VALUES (%s)',
    ...
    {
        $pos = PatientphoneTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Patientphone'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Patientphone'][$this->hashCode()] = true;
        $keys = PatientphoneTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PatientphoneTableMap::COL_PATIENT_ID)) {
            $criteria->add(PatientphoneTableMap::COL_PATIENT_ID, $this->patient_id);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Patientphone (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Patientphone Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPatient(ConnectionInterface $con = null)
    {
        if ($this->aPatient === null && ($this->patient_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPatient->addPatientphones($this);
             */
        }
    ...
    {
        if (null !== $this->aPatient) {
            $this->aPatient->removePatientphone($this);
        }
    ...
    {
        return (string) $this->exportTo(PatientphoneTableMap::DEFAULT_STRING_FORMAT);
    }
